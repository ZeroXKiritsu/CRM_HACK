# Generated by Django 3.2.6 on 2021-08-22 12:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_number', phonenumber_field.modelfields.PhoneNumberField(max_length=128, null=True, region=None)),
                ('address_type', models.CharField(blank=True, choices=[('RA', 'Registered address'), ('REA', 'Residential address')], max_length=255, null=True)),
                ...
                ('communication_number', phonenumber_field.modelfields.PhoneNumberField(max_length=128, null=True, region=None)),
